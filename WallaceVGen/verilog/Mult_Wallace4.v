...
Half_Adder HA4 (P[1][3], P[2][2], S[3], Cout[3]);
Half_Adder HA5 (Cout[0], S[1], S[4], Cout[4]);
Full_Adder FA6 (P[3][0], Cout[1], S[2], S[5], Cout[5]);
Full_Adder FA7 (P[3][1], Cout[2], S[3], S[6], Cout[6]);
Full_Adder FA8 (P[2][3], P[3][2], Cout[3], S[7], Cout[7]);
Half_Adder HA9 (Cout[4], S[5], S[8], Cout[8]);
Full_Adder FA10 (Cout[5], S[6], Cout[8], S[9], Cout[9]);
Full_Adder FA11 (Cout[6], S[7], Cout[9], S[10], Cout[10]);
Full_Adder FA12 (P[3][3], Cout[7], Cout[10], S[11], Cout[11]);
